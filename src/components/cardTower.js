  ...
  return (
    ...
    >
      ...
      <div className="d-flex flex-wrap justify-content-center row m-0">
        ...
        >
            <InnerCard title={"Codice"} description={torre.id_tower}></InnerCard>
        </div>
        <div
          className={"card col-sm-4 col-md-3 col-lg-3 col-xl-2 p-0 innercardorders"}
        >
            <InnerCard title={"Info"} description={torre.title+" - fazzoletti "+torre.tissue_quantity}></InnerCard>
        </div>
        <div
          className={"card col-sm-4 col-md-3 col-lg-2 p-0 innercardorders"}
        >
            <InnerCard title={"Indirizzo"} description={torre.address}></InnerCard>
        </div>
        <div
          className={"card col-sm-4 col-md-3 col-lg-3 col-xl-2 p-0 innercardorders"}
        >
            <InnerCard title={"Descrizione"} description={torre.description}></InnerCard>
        </div>
        <div
          className={"card col-sm-4 col-md-3 col-lg-2 p-0 innercardorders"}
        >
            <InnerCard title={"Coordinate"} description={torre.latitude+" "+torre.longitude}></InnerCard>
        </div>
        <div
          className={"card col-sm-4 col-md-3 col-lg-2 p-0 innercardorders"}
        >
            <InnerCard title={"Proprietario???"} description={torre.id_user_customer}></InnerCard>
        </div>
        <div
