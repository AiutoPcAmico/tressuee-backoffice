  ...
  return (
    ...
    >
      ...
      {<div className="d-flex flex-wrap justify-content-center row m-0">
        ...
        >
            <InnerCard w={wi} title={"Codice"} description={torre?.id_tower} i={indice}></InnerCard>
        </div>
        <div
          className={"card col-sm-4 col-md-3 col-lg-3 col-xl-2 p-0 innercardorders"}
        >
            <InnerCard w={wi} title={"Info"} description={torre?.title+" - fazzoletti "+torre?.tissue_quantity} i={indice}></InnerCard>
        </div>
        <div
          className={"card col-sm-4 col-md-3 col-lg-2 p-0 innercardorders"}
        >
            <InnerCard w={wi} title={"Indirizzo"} description={torre?.address} i={indice}></InnerCard>
        </div>
        <div
          className={"card col-sm-4 col-md-3 col-lg-3 col-xl-2 p-0 innercardorders"}
        >
            <InnerCard w={wi} title={"Descrizione"} description={torre?.description} i={indice}></InnerCard>
        </div>
        <div
          className={"card col-sm-4 col-md-3 col-lg-2 p-0 innercardorders"}
        >
            <InnerCard w={wi} title={"Coordinate"} description={torre?.latitude+" "+torre?.longitude} i={indice}></InnerCard>
        </div>
        <div
          className={"card col-sm-4 col-md-3 col-lg-2 p-0 innercardorders"}
        >
            <InnerCard w={wi} title={"Pubblica"} description={torre?.is_public ? "si" :"no"} i={indice}></InnerCard>
        </div>
        {indice!==-1 && <div
        ...
        >
          <div className="card-body p-1 row">
            ...
            <button
                ...
                onClick={()=>{navigate("/towers/detail/"+torre.id_tower)}}
              >
